...
window.addEventListener("DOMContentLoaded", function () {
  var mainPageSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: ".page",
    btns: ".next"
  });
  mainPageSlider.render();
  var modulePageSlider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: ".moduleapp",
  ...
  var showUpSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  player.init();
  var officerold = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"](".officerold", ".officer__card-item", ".officerold .plus");
  officerold.init();
  var officernew = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"](".officernew", ".officer__card-item", ".officernew .plus");
  officernew.init();
...
/*#__PURE__*/
function () {
  function Difference(container, cards, btns) {
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.addEventListener("click", function () {
        if (_this2.counter !== _this2.cards.length - 2) {
          _this2.cards[_this2.counter].style.display = "flex";
          _this2.counter++;
        } else {
          _this2.cards[_this2.counter].style.display = "flex";

          _this2.cards[_this2.cards.length - 1].classList.add("animated", "fadeOut");
        }
      });
    }
  }, {
...
/*#__PURE__*/
function () {
  function Forms(forms, inputs, url) {
  ...
  _createClass(Forms, [{
    ...
    value: function checkMail() {
      var mailInputs = document.querySelectorAll("[name='email']");
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener("submit", function (event) {
          ...
          _this.postData(_this.path, data).then(function (res) {
            console.log(res);
...
/*#__PURE__*/
function () {
  function Player(triggers, overlay) {
...
function (_Slider) {
  ...
  function MainSlider(btns, nextModule, prevModule) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, nextModule, prevModule));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.nextModule.forEach(function (next) {
      ...
      this.prevModule.forEach(function (prev) {
